...
4. Select: `relay-next/dist/chrome`
...
3. Select: `relay-next/dist/firefox/manifest.json`
4. Click extension icon once on target tab to bind.

## Release ZIP install
- Chrome ZIP: `relay-next/release/relay-next-chrome.zip`
- Firefox ZIP: `relay-next/release/relay-next-firefox.zip`
